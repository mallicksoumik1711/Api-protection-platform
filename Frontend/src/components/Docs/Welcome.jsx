      ...
      <div className="max-w-6xl mx-auto flex gap-16">
        ...
        <div className="flex-1 min-w-0">
          ...
          <section id="get-started" className="mt-10">
            <h2 className="text-2xl sm:text-3xl font-semibold">Get Started with Bouncer</h2>

            <p className="mt-4 text-base sm:text-lg leading-7 sm:leading-8 text-zinc-400">
            ...
            <p className="mt-8 text-base sm:text-lg leading-7 sm:leading-8 text-zinc-400">
              See the{" "}
          ...
          <section id="core-capabilities" className="mt-16">
            <h2 className="text-2xl sm:text-3xl font-semibold">Core Capabilities</h2>
          ...
          <section id="integrations" className="mt-16">
            <h2 className="text-2xl sm:text-3xl font-semibold">Integrations & APIs</h2>
          ...
          <section id="best-practices" className="mt-16 mb-24">
            <h2 className="text-2xl sm:text-3xl font-semibold">Best Practices</h2>
