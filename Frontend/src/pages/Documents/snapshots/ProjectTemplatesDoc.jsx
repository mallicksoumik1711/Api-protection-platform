...
import DocsProjectTemplates from "../../../components/Docs/docs-snapshots/DocsProjectTemplates";

function ProjectTemplatesDoc() {
  return (
...
export default ProjectTemplatesDoc;
