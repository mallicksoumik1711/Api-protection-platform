    ...
    <div className="bg-black px-6 py-4">
      ...
      <div className="mt-10 max-w-6xl mx-auto flex justify-between gap-10">
        ...
        <div className="flex flex-col h-fit sticky top-6 w-1/2">
          <div className="bg-black border border-zinc-900 rounded-lg px-6 py-5 shadow-inner">
          ...
          <div className="mt-5 bg-black border border-zinc-800 rounded-lg px-7 py-4 shadow-inner">
            <div>
