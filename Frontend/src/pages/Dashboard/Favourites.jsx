        ...
        <div>
          ...
          <div className="grid lg:grid-cols-1 gap-6">
            ...
            {filteredProjects.length > 0 ? (
              ...
              <div className="bg-zinc-950 border border-zinc-900 flex flex-col text-center sm:text-left justify-center items-center py-10 lg:py-20 rounded-lg text-zinc-500 gap-5 px-4 sm:mt-0 mt-10">
                <Ghost />
