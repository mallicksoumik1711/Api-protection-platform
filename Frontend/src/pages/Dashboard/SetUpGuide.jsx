...
function StepCard({ step, title, description, image, route }) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-center bg-zinc-950 border border-zinc-900 rounded-lg px-8 py-4 transition-all duration-300">
      <div className="lg:col-span-5 space-y-6">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-zinc-900 hover:bg-zinc-950/80 border border-zinc-800 px-6 py-3 rounded-md text-sm text-white transition-all duration-200"
        >
      ...
      <div className="lg:col-span-7">
        <div className="relative group h-[380px] overflow-hidden rounded-md border border-zinc-800 bg-zinc-950 shadow-inner">
          <img
            src={image}
            alt={title}
          ...
          <div className="absolute top-2 right-4 text-[10px] font-mono bg-black/70 px-3 py-1 rounded-full border border-emerald-700 text-emerald-400 bg-emerald-500/20">
            PREVIEW
          </div>
        </div>
      </div>
